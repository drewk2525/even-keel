...
# Database: EvenKeel
# Generation Time: 2018-01-21 21:01:39 +0000
# ************************************************************
...
VALUES
	...
	(52,1,60,63,'2018-01-02 18:06:53');
...
LOCK TABLES `LKDistanceType` WRITE;
/*!40000 ALTER TABLE `LKDistanceType` DISABLE KEYS */;

INSERT INTO `LKDistanceType` (`DistanceTypeID`, `DistanceTypeDescription`, `DistanceTypeUnits`, `OwnerTypeID`, `OwnerID`)
VALUES
	(1,'Meters','m',1,NULL),
	(2,'Miles','mi',1,NULL),
	(3,'Kilometers','km',1,NULL);

/*!40000 ALTER TABLE `LKDistanceType` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `Notes` (`NoteID`, `SystemAreaTypeID`, `SystemAreaID`, `NoteContent`, `CreatedByUserID`, `ForUserID`, `CreateDT`)
VALUES
	(1,1,60,'testing',63,63,'2017-12-31 22:27:17'),
	(2,1,60,'Here is a new note!!',63,63,'2017-12-31 23:31:30'),
	(8,1,60,'Let\'s try adding some really, super duper, duper duper duper duper duper long note.  I\'ll keep typing just to see if we can get some absurbly long note in here, so we can test how this stores in the DB and how it displays on the front end as well.  Might want to change this to a text field instead of an input field',63,63,'2017-12-31 23:44:16'),
	(9,1,60,'Here, try this',63,63,'2018-01-01 00:16:52'),
	(12,1,60,'Just adding a new note. Nothing to see here. Moving along.',63,63,'2018-01-01 00:37:38'),
	(13,1,60,'Katie\'s note for this workout',63,63,'2018-01-01 01:29:33'),
	(14,1,60,'Mark\'s note on this workout',63,63,'2018-01-01 02:53:23'),
	(15,1,60,'Some new note',63,63,'2018-01-02 18:09:28');

/*!40000 ALTER TABLE `Notes` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table SystemAreaType
# ------------------------------------------------------------
...
LOCK TABLES `SystemAreaType` WRITE;
/*!40000 ALTER TABLE `SystemAreaType` DISABLE KEYS */;

INSERT INTO `SystemAreaType` (`SystemAreaTypeID`, `SystemAreaTypeDescription`)
VALUES
	(1,'WorkoutSession'),
	(2,'Workout'),
	(3,'WorkoutSets'),
	...
	(5,'Notes'),
	(6,'HeartRates'),
	(7,'AthleteStatHistory');

/*!40000 ALTER TABLE `SystemAreaType` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	(63,60,'Erg workout',NULL,NULL,NULL),
	(64,59,'2 x 2k',NULL,NULL,NULL),
	(65,60,'Jason\'s activity',NULL,NULL,NULL);
...
INSERT INTO `WorkoutSets` (`WorkoutSetID`, `WorkoutID`, `WorkoutSetTypeID`, `Weight`, `Reps`, `ExerciseTime`, `Distance`, `DistanceTypeID`, `SplitTime`, `SPM`, `RestTime`, `DesiredIntensity`, `DesiredIntensityTypeID`, `HeartRateID`)
VALUES
	(3,1,3,NULL,NULL,1200,NULL,1,NULL,NULL,NULL,2,2,NULL),
	(4,6,1,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL),
	(5,56,1,250,5,484,NULL,1,121,30,240,NULL,NULL,NULL),
	(6,63,1,123,2,3600,NULL,1,120,26,300,NULL,NULL,NULL),
	(7,63,1,250,5,424,NULL,1,106,32,120,NULL,NULL,NULL),
	(8,63,1,250,5,424,NULL,1,106,32,120,NULL,NULL,NULL),
	(9,63,1,150,12,481.2,NULL,1,120.3,32,120.5,NULL,NULL,NULL),
	(10,64,1,250,5,500,NULL,1,125,28,240,NULL,NULL,NULL),
	(13,63,1,250,12,484.4,2,3,121.1,26,240,NULL,NULL,NULL),
	(14,63,1,125,15,420,2000,1,105,32,240,NULL,NULL,NULL);
